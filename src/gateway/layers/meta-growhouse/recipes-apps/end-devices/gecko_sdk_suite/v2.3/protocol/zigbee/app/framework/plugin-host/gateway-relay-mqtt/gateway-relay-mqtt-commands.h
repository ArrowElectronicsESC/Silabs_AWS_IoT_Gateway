...
#define COMMAND_STRING_DEVICE_TABLE_PRINT \
  "plugin device-table print\0"
...
#define COMMAND_STRING_ZDO_BIND \
  "zdo bind\0"
#define COMMAND_STRING_ZDO_UNBIND_UNICAST \
  "zdo unbind unicast\0"
...
#define COMMAND_STRING_ZCL_MOVE_TO_LEVEL \
  "zcl level-control mv-to-level\0"
...
#define COMMAND_STRING_CUSTOM_SET_LED_CHANNEL \
  "custom set-led-channel\0"
#define COMMAND_STRING_CUSTOM_GET_LED_INTENSITY \
  "custom get-led-intensity\0"
#define COMMAND_STRING_CUSTOM_GET_LED_CONFIGURATION \
  "custom get-led-configuration\0"
#define COMMAND_STRING_CUSTOM_GET_ENDNODE_FIRMWARE \
  "custom get-end-node-firmware\0"
#define COMMAND_STRING_CUSTOM_SEND_BIND_REQUEST \
  "custom soilnode-bind-request\0"
#define COMMAND_STRING_CUSTOM_ADD_OTA_DEVICE \
  "custom add_ota_device\0"
#define COMMAND_STRING_CUSTOM_REMOVE_OTA_DEVICE \
  "custom remove_ota_device\0"
#define COMMAND_STRING_CUSTOM_PRINT_OTA_DEVICE \
  "custom print_ota_device\0"
...
void emAfPluginGatewayRelayMqttZdoUnBindUnicast(const uint8_t *);
...
void emAfPluginGatewayRelayMqttZclMoveToLevel(const uint8_t *);
...
void emAfPluginGatewayRelayMqttDeviceTablePrint(const uint8_t *);
...
void emAfPluginGatewayRelayMqttCommandSetledChannel(const uint8_t * );
void emAfPluginGatewayRelayMqttCommandGetledIntensity(const uint8_t * );
void emAfPluginGatewayRelayMqttCommandGetledConfiguration(const uint8_t * );
void emAfPluginGatewayRelayMqttCommandGetEndnodeFirmware(const uint8_t * );
void emAfPluginGatewayRelayMqttCommandSendBindRequest(const uint8_t *);
void emAfPluginGatewayRelayMqttCommandAddOtaDevice(const uint8_t *);
void emAfPluginGatewayRelayMqttCommandRemoveOtaDevice(const uint8_t *);
void emAfPluginGatewayRelayMqttCommandPrintOtaDevice(const uint8_t *);
