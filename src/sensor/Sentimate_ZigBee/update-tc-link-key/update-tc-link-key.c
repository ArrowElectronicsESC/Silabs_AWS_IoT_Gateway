...
#ifdef EZSP_HOST
  #define requestLinkKey ezspUpdateTcLinkKey
#else
  #define requestLinkKey emberUpdateTcLinkKey
#endif
...
EmberStatus emberAfPluginUpdateTcLinkKeyStart(void)
{
  ...
  status = requestLinkKey(EMBER_AF_PLUGIN_UPDATE_TC_LINK_KEY_MAX_ATTEMPTS);
